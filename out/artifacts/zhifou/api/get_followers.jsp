<%@ page import="util.Json"%><%@ page import="java.util.Map"%><%@ page import="beans.User"%><%@ page import="java.util.ArrayList"%><%@ page import="java.util.HashMap"%><%--
...
<%
    ...
    if (user.getUsername()!=null){
        ArrayList<User> u  ;u = user.getFollowers();
        ArrayList<Map<String, Object>> obj = new ArrayList<>();
        if (u==null){
            success = false;
            res.put("error", "未知错误");
        }else if (self == null){
            for(User i: u){                Map<String, Object> m = i.getFields();
